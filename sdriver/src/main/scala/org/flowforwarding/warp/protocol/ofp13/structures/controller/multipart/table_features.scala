...
case class ofp_table_features private[protocol] (
...
object ofp_multipart_table_features_request {
  private [protocol] def build(structures: RawSeq[ofp_table_features]) = ofp_multipart_table_features_request(structures.toArray)
}

case class ofp_multipart_table_features_reply private [protocol] (features: RawSeq[ofp_table_features])