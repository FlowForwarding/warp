...
case class ofp_meter_multipart_request private[protocol] (meter_id: UInt32, /* Meter instance, or OFPM_ALL. */
                                                          pad: Pad4) /* Align to 64 bits. */

object ofp_meter_multipart_request {
  private[protocol] def build(meter_id: UInt32) = ofp_meter_multipart_request(meter_id, Pad4())
...
object ofp_meter_stats extends RawSeqFieldsInfo {
  ...
  private [protocol] def build(structure: ofp_meter_multipart_request) = ofp_multipart_meter_stats_request(structure)
...
case class ofp_multipart_meter_stats_request private [protocol] (structure: ofp_meter_multipart_request) extends MultipartRequest[ofp_meter_multipart_request] {
...
case class ofp_multipart_meter_stats_reply private [protocol] (stats: RawSeq[ofp_meter_stats])