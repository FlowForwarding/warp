...
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_config_flags.CONFIG_FLAGS
...
case class ofp_switch_config_request private[protocol] (header: ofp_header)
