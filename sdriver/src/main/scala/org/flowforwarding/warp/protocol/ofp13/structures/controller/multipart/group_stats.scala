...
case class ofp_group_stats_request private[protocol] (
...
//  private[protocol] def build(length: UInt16,
//                              group_id: UInt32,
//                              ref_count: UInt32,
//                              packet_count: UInt64,
//                              byte_count: UInt64,
...
case class ofp_bucket_counter private[protocol] (
...
//  private[protocol] def build(packet_count: UInt64,
//                              byte_count: UInt64) = ofp_bucket_counter(packet_count, byte_count)
//}

case class ofp_multipart_group_stats_request private [protocol] (structure: ofp_group_stats_request) extends MultipartRequest[ofp_group_stats_request] {
...
object ofp_multipart_group_stats_request {
  private [protocol] def build(structure: ofp_group_stats_request) = ofp_multipart_group_stats_request(structure)
}

case class ofp_multipart_group_stats_reply private [protocol] (stats: RawSeq[ofp_group_stats])