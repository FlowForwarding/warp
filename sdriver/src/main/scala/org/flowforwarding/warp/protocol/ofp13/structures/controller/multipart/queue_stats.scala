...
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_port_no._
...
object ofp_queue_stats_request{
  private[protocol] def build(port_no: OFP_PORT_NO, queue_id: UInt32) = ofp_queue_stats_request(port_no, queue_id)
}
  
case class ofp_queue_stats private[protocol] (
  port_no: OFP_PORT_NO,
...
//  private[protocol] def build(port_no: OFP_PORT_NO,
//            queue_id: UInt32,
//            tx_bytes: UInt64,
//            tx_packets: UInt64,
//            tx_errors: UInt64,
...
case class ofp_multipart_queue_stats_request private [protocol] (structure: ofp_queue_stats_request) extends MultipartRequest[ofp_queue_stats_request] {
...
object ofp_multipart_queue_stats_request {
  private [protocol] def build(structure: ofp_queue_stats_request) = ofp_multipart_queue_stats_request(structure)
}

case class ofp_multipart_queue_stats_reply private [protocol] (stats: RawSeq[ofp_queue_stats])