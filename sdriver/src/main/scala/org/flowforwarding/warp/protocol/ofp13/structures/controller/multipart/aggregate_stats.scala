...
case class ofp_aggregate_stats_request private [protocol](
...
case class ofp_multipart_aggregate_stats_request private [protocol] (structure: ofp_aggregate_stats_request) extends MultipartRequest[ofp_aggregate_stats_request] {
...
object ofp_multipart_aggregate_stats_request {
  private [protocol] def build(structure: ofp_aggregate_stats_request) = ofp_multipart_aggregate_stats_request(structure)
}

case class ofp_multipart_aggregate_stats_reply private [protocol] (stats: ofp_aggregate_stats)