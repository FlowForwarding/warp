...
public class EncoderFactory {
   ...
   * @see Encoder
   */
  public BinaryEncoder binaryNonEncoder(OutputStream out, BinaryEncoder reuse) {
     if (null == reuse || !reuse.getClass().equals(BufferedBinaryNonEncoder.class)) {
      return new BufferedBinaryNonEncoder(out, this.binaryBufferSize);
     }  else {
      return ((BufferedBinaryNonEncoder)reuse).configure(out, this.binaryBufferSize);
     }
  }
