...
case class ofp_instruction_goto_table private[protocol] (
  length: INSTRUCTION_LENGTH,
  table_id: UInt8,
  pad: Pad3) extends ofp_instruction

object ofp_instruction_goto_table {
  private [protocol] def build(table_id: UInt8) = ofp_instruction_goto_table(IL_GOTO_TABLE, table_id, Pad3())
}

case class ofp_instruction_write_metadata private[protocol] (
  length: INSTRUCTION_LENGTH,
...
object ofp_instruction_write_metadata {
  private [protocol] def build(metadata: UInt64, metadata_mask: UInt64) = ofp_instruction_write_metadata(IL_WRITE_METADATA, Pad4(), metadata, metadata_mask)
}
...
case class ofp_instruction_write_actions private[protocol] (
  length: INSTRUCTION_LENGTH,
  pad: Pad4,                                           /* Align to 64-bits */
...
case class ofp_instruction_apply_actions private[protocol] (
  length: INSTRUCTION_LENGTH,
  pad: Pad4,                                           /* Align to 64-bits */
  actions: RawSeq[ofp_action]) extends ofp_instruction /* 0 or more actions associated with OFPIT_WRITE_ACTIONS and OFPIT_APPLY_ACTIONS */
...
case class ofp_instruction_clear_actions private[protocol] (
  length: INSTRUCTION_LENGTH,
  pad: Pad4,                                           /* Align to 64-bits */
  actions: RawSeq[ofp_action]) extends ofp_instruction /* 0 or more actions associated with OFPIT_WRITE_ACTIONS and OFPIT_APPLY_ACTIONS */
...
case class ofp_instruction_meter private[protocol] (
  length: INSTRUCTION_LENGTH,
  meter_id: UInt32) extends ofp_instruction

object ofp_instruction_meter {
  private [protocol] def build(meter_id: UInt32) = ofp_instruction_meter(IL_METER, meter_id)
}

case class ofp_instruction_experimenter private[protocol] (
  length: INSTRUCTION_LENGTH,
