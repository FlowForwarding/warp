...
case class ofp_experimenter_header private[protocol] (header: ofp_header,            /* Type OFPT_EXPERIMENTER. */
...
object ofp_experimenter_header extends RawSeqFieldsInfo{
  ...
  private[protocol] def build(@DynamicPath("header", "xid") xid: UInt32, experimenter: UInt32, exp_type: UInt32, data: RawSeq[UInt8] = RawSeq()) = {
