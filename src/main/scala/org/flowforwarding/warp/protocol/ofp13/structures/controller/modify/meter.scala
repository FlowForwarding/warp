...
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_meter_band_type.OFP_METER_BAND_TYPE
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_meter.OFP_METER
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_meter_mod_command.OFP_METER_MOD_COMMAND
import org.flowforwarding.warp.protocol.ofp13.structures.ofp_meter_flags.OFP_METER_FLAGS
import org.flowforwarding.warp.protocol.dynamic.DynamicPath
import ofp_length._

/* Meter configuration. */
case class ofp_meter_mod private [protocol] (
  header: ofp_header,
...
case class ofp_meter_band_header private [protocol] (
...
case class ofp_meter_band_drop private [protocol] (header: ofp_meter_band_header, pad: Pad4) extends ofp_meter_band

object ofp_meter_band_drop{
  private[protocol] def build(@DynamicPath("header", "rate") rate: UInt32,
...
case class ofp_meter_band_dscp_remark private [protocol] (header: ofp_meter_band_header, prec_level: UInt8, pad: Pad3) extends ofp_meter_band
...
case class ofp_meter_band_experimenter private [protocol] (header: ofp_meter_band_header, experimenter: UInt32) extends ofp_meter_band
