...
public class GenericData {
  ...
  /** Default implementation of {@link GenericBitmap}.*/
  public static class Bitmap implements GenericBitmap {
    private final Schema schema;
    
    public Bitmap(Schema schema) {
      if (schema == null || !Type.BITMAP.equals(schema.getType()))
        throw new AvroRuntimeException("Not a bitmap schema: "+schema);
      this.schema = schema;
    }
