...
// TODO DO IMPLEMENT CLASS GROUP_MOD
    GROUP_MOD           (15, OFGroupMod.class, new Instantiable<OFMessage>() {  // 20
                                @Override
                                public OFMessage instantiate() {
                                    return new OFGroupMod();
                                }}),       
    PORT_MOD            (16, OFPortMod.class, new Instantiable<OFMessage>() { 	// 15
                            @Override
                            public OFMessage instantiate() {
                                return new OFPortMod();
                            }}),
// TODO DO IMPLEMENT CLASS TABLE_MOD
    TABLE_MOD           (17, OFTableMod.class, new Instantiable<OFMessage>() { // 21
                                @Override
                                public OFMessage instantiate() {
                                    return new OFTableMod();
                                }}),                            
    STATS_REQUEST       (18, OFStatisticsRequest.class, new Instantiable<OFMessage>() { // 16
                            @Override
                            public OFMessage instantiate() {
                                return new OFStatisticsRequest();
                            }}),
    STATS_REPLY         (19, OFStatisticsReply.class, new Instantiable<OFMessage>() { // 17
                            @Override
                            public OFMessage instantiate() {
                                return new OFStatisticsReply();
                            }}),
    BARRIER_REQUEST     (20, OFBarrierRequest.class, new Instantiable<OFMessage>() { // 18
                            @Override
                            public OFMessage instantiate() {
                                return new OFBarrierRequest();
                            }}),
     BARRIER_REPLY       (21, OFBarrierReply.class, new Instantiable<OFMessage>() { // 19
                            @Override
                            public OFMessage instantiate() {
                                return new OFBarrierReply();
                            }}),
// TODO IMPLEMENT CLASS QUEUE_GET_CONFIG_REQUEST     
    QUEUE_GET_CONFIG_REQUEST (22, OFBarrierReply.class, new Instantiable<OFMessage>() {
                                @Override
                                public OFMessage instantiate() {
                                    return new OFQueueGetConfigRequest();
                                }}),                            
// TODO IMPLEMENT CLASS QUEUE_GET_CONFIG_REPLY
   QUEUE_GET_CONFIG_REPLY (23, OFBarrierReply.class, new Instantiable<OFMessage>() {
                                @Override
                                public OFMessage instantiate() {
                                    return new OFQueueGetConfigReply();
                                }}),
// TODO IMPLEMENT CLASS OFPT_ROLE_REQUEST
    ROLE_REQUEST        (24, OFBarrierReply.class, new Instantiable<OFMessage>() {
                            @Override
                            public OFMessage instantiate() {
                                return new OFRoleRequest();
                            }}),         
// TODO IMPLEMENT CLASS ROLE_REPLY
    ROLE_REPLY          (25, OFBarrierReply.class, new Instantiable<OFMessage>() {
                            @Override
                            public OFMessage instantiate() {
