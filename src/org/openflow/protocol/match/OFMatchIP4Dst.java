...
public class OFMatchIP4Dst extends OFMatchOXM implements Cloneable {

	public static short MINIMUM_LENGTH = 8;
	public static short OXM_LENGTH = 4;
	
    protected static int OXM_HEADER_IP4_DST = (int) ( (OXMClass.OFPXMC_OPENFLOW_BASIC.getValue() << 16) | OXMField.OFPXMT_OFB_IPV4_DST.getValue() << 9 | 0 << 8 | OXM_LENGTH);
	...
	public OFMatchIP4Dst(int oxmTLV) {
		super(OXM_HEADER_IP4_DST);
		this.oxmTLV = oxmTLV;
		this.length = OXM_LENGTH;		
	}
	
	public OFMatchIP4Dst() {
		super(OXM_HEADER_IP4_DST);
