...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_group_capabilities.OFP_GROUP_CAPABILITIES
...
case class ofp_multipart_group_features_request private [sdriver] () extends EmptyMultipartRequest {
  override def tp: OFP_MULTIPART_TYPE = ofp_multipart_type.OFPMP_GROUP_FEATURES
}

object ofp_multipart_group_features_request {
  private [sdriver] def build() = ofp_multipart_group_features_request()
}

case class ofp_multipart_group_features_reply private [sdriver] (features: ofp_group_features)