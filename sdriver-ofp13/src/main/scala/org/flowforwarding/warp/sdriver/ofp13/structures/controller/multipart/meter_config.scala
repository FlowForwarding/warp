...
case class ofp_multipart_meter_config_request private [sdriver] (structure: ofp_meter_multipart_request) extends MultipartRequest[ofp_meter_multipart_request] {
...
object ofp_multipart_meter_config_request {
  private [sdriver] def build(structure: ofp_meter_multipart_request) = ofp_multipart_meter_config_request(structure)
}

case class ofp_multipart_meter_config_reply private [sdriver] (config: RawSeq[ofp_meter_config])