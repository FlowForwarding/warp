...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_controller_role.OFP_CONTROLLER_ROLE
...
case class ofp_role_request private[sdriver] (
  header: ofp_header,
...
object ofp_role_request{
  ...
  private[sdriver] def build(@DynamicPath("header", "xid") xid: UInt32, role: OFP_CONTROLLER_ROLE, generation_id: UInt64) =
...
case class ofp_role_reply private[sdriver] (header: ofp_header,
                          role: OFP_CONTROLLER_ROLE, /* One of OFPCR_ROLE_*. */
                          pad: Pad4,                 /* Align to 64 bits. */
                          generation_id: UInt64)     /* Master Election Generation Id */
