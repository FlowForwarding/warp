...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_controller_max_len.OFP_CONTROLLER_MAX_LEN
...
case class ofp_action_copy_ttl_out private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_copy_ttl_out {
  private [sdriver] def build = ofp_action_copy_ttl_out(AL_COPY_TTL_OUT, Pad4())
}

case class ofp_action_copy_ttl_in private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_copy_ttl_in {
  private [sdriver] def build = ofp_action_copy_ttl_in(AL_COPY_TTL_IN, Pad4())
}

case class ofp_action_dec_mpls_ttl private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_dec_mpls_ttl {
  private [sdriver] def build = ofp_action_dec_mpls_ttl(AL_DEC_MPLS_TTL, Pad4())
}

case class ofp_action_pop_vlan private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_pop_vlan {
  private [sdriver] def build = ofp_action_pop_vlan(AL_POP_VLAN, Pad4())
}

case class ofp_action_dec_nw_ttl private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_dec_nw_ttl {
  private [sdriver] def build = ofp_action_dec_nw_ttl(AL_DEC_NW_TTL, Pad4())
}

case class ofp_action_pop_pbb private [sdriver] (len: OFP_ACTION_LENGTH, pad: Pad4) extends ofp_action
object ofp_action_pop_pbb {
  private [sdriver] def build = ofp_action_pop_pbb(AL_POP_PBB, Pad4())
}
 ...
 * the controller. */
case class ofp_action_output private [sdriver] (
...
object ofp_action_output {
  private [sdriver] def build(port: UInt32, max_len: OFP_CONTROLLER_MAX_LEN) = ofp_action_output(AL_OUTPUT, port, max_len, Pad6())
}
...
case class ofp_action_group private [sdriver] (len: OFP_ACTION_LENGTH, groupId: UInt32) extends ofp_action
object ofp_action_group { def build(groupId: UInt32) = ofp_action_group(AL_GROUP, groupId) }

/* OFPAT_SET_QUEUE action struct: send packets to given queue on port. */
case class ofp_action_set_queue private [sdriver] (len: OFP_ACTION_LENGTH, queueId: UInt32) extends ofp_action
...
case class ofp_action_nw_ttl private [sdriver] (len: OFP_ACTION_LENGTH, nw_ttl: UInt8, pad: Pad3) extends ofp_action
...
case class ofp_action_push_vlan private [sdriver] (len: OFP_ACTION_LENGTH, ethertype: UInt16, pad: Pad2) extends ofp_action
object ofp_action_push_vlan {
  def build(ethertype: UInt16) = ofp_action_push_vlan(AL_PUSH_VLAN, ethertype, Pad2()) }

case class ofp_action_push_mpls private [sdriver] (len: OFP_ACTION_LENGTH, ethertype: UInt16, pad: Pad2) extends ofp_action
object ofp_action_push_mpls {
  def build(ethertype: UInt16) = ofp_action_push_mpls(AL_PUSH_MPLS, ethertype, Pad2()) }

case class ofp_action_push_pbb private [sdriver] (len: OFP_ACTION_LENGTH, ethertype: UInt16, pad: Pad2) extends ofp_action
object ofp_action_push_pbb {
  def build(ethertype: UInt16) = ofp_action_push_pbb(AL_PUSH_PBB, ethertype, Pad2()) }

/* Action structure for OFPAT_POP_MPLS. */
case class ofp_action_pop_mpls private [sdriver] (len: OFP_ACTION_LENGTH, ethertype: UInt16, pad: Pad2) extends ofp_action
...
case class ofp_action_set_field private [sdriver] (
...
object ofp_action_set_field extends RawSeqFieldsInfo{
  ...
  private [sdriver] def build(field: oxm_tlv) = {
...
case class ofp_action_experimenter_header private [sdriver] (len: OFP_ACTION_LENGTH, experimenter: UInt32) extends ofp_action
object ofp_action_experimenter_header {
  private [sdriver] def build(experimenter: UInt32) = ofp_action_experimenter_header(AL_EXPERIMENTER, experimenter)
}
