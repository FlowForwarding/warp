...
case class ofp_get_async_request private[sdriver] (header: ofp_header)
...
case class ofp_get_async_reply private[sdriver] (
  header: ofp_header,
...
case class ofp_set_async private[sdriver] (
   header: ofp_header,
   packet_in_mask:    UInt64, /* Bitmasks of OFPR_* values. */
   port_status_mask:  UInt64, /* Bitmasks of OFPPR_* values. */
   flow_removed_mask: UInt64) /* Bitmasks of OFPRR_* values. */
