...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_hello_elem_type.OFP_HELLO_ELEM_TYPE

import com.gensler.scalavro.types.supply._
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_hello.ofp_hello_elem
...
case class ofp_hello private[sdriver] (header: ofp_header, elements: RawSeq[ofp_hello_elem])/* List of hello elements - 0 or more */ // TODO: skip unrecognized headers
...
object ofp_hello extends RawSeqFieldsInfo{
  ...
  private[sdriver] def build(@DynamicPath("header", "xid") xid: UInt32, elements: RawSeq[ofp_hello_elem] = RawSeq()) = {
...
case class ofp_hello_elem_versionbitmap private[sdriver] (//hType: OFP_HELLO_ELEM_TYPE = OFPHET_VERSIONBITMAP, /* One of OFPHET_*. */
                                        length: UInt16,             /* Length in bytes of the element, including this header, excluding padding. */
                                        /* Followed by:
...
object ofp_hello_elem_versionbitmap extends RawSeqFieldsInfo{
  ...
  private[sdriver] def build(bitmaps: RawSeq[UInt32] = RawSeq()) = {
