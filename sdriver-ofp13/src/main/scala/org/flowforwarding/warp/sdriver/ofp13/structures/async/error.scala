...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_error_type.OFP_ERROR_TYPE
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_error_code.OFP_ERROR_CODE
...
case class ofp_error_msg private[sdriver] (
  header: ofp_header,
...
case class ofp_error_experimenter_msg private[sdriver] (
  header: ofp_header,
  eType: OFP_ERROR_TYPE,
