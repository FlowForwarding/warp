...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_length.OFP_LENGTH
import com.gensler.scalavro.util.Union._
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_type.OFP_TYPE
...
object ofp13_messages {
  ...
  type Ofp13Msg = org.flowforwarding.warp.sdriver.OfpMsg[All, _]
  type TaggedOfp13Message = ByteTaggedUnion[All, OFP_TYPE]
}


case class ofp_header private[sdriver](length: OFP_LENGTH, xid: UInt32)
