...
import org.flowforwarding.warp.sdriver.dynamic.ReflectiveMessageDriver
...
import org.flowforwarding.warp.sdriver._
...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_header
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_switch_features_reply
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_switch_features_request
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_switch_config_reply
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_switch_config_request
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_set_config
...
class Ofp13Impl extends StaticDriver[ofp13_messages.All, Ofp13Impl]{
  ...
  override def toReflectiveDriver(classes: Iterable[Class[_]]): ReflectiveMessageDriver = {
    new ReflectiveMessageDriver(this, classes) with Ofp13DriverApi {
