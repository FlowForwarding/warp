...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_queue_property.OFP_QUEUE_PROPERTY
...
case class ofp_packet_queue private[sdriver] (
...
case class ofp_queue_prop_header private[sdriver] (len: UInt16, pad: Pad4)

/* Min-Rate queue property description. */
case class ofp_queue_prop_min_rate private[sdriver] (
...
case class ofp_queue_prop_max_rate private[sdriver] (
...
case class ofp_queue_prop_experimenter private[sdriver] (
