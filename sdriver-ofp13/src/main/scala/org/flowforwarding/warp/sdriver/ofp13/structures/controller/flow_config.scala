...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_table.OFP_TABLE
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_table_config.OFP_TABLE_CONFIG
...
case class ofp_table_mod private[sdriver] (
  header: ofp_header,
...
object ofp_table_mod{
  ...
  private[sdriver] def build(@DynamicPath("header", "xid") xid: UInt32, table_id: OFP_TABLE, config: OFP_TABLE_CONFIG) =
