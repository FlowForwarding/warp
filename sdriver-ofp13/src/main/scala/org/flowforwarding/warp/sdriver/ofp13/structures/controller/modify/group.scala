...
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_group_mod_command.OFP_GROUP_COMMAND
import org.flowforwarding.warp.sdriver.ofp13.structures.ofp_group_type.OFP_GROUP_TYPE
...
case class ofp_group_mod private[sdriver] (
  header: ofp_header,
...
case class ofp_bucket private[sdriver] (
...
object ofp_bucket extends RawSeqFieldsInfo{
  ...
  private[sdriver] def build(weight: UInt16,
                              watch_port: UInt32,
                              watch_group: UInt32,
                              actions: RawSeq[ofp_action]) = {
