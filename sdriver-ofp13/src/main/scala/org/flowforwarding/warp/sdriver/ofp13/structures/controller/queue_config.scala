...
case class ofp_queue_get_config_request private[sdriver] (header: ofp_header,
...
object ofp_queue_get_config_request{
  ...
  private[sdriver] def build(@DynamicPath("header", "xid") xid: UInt32, port: UInt32) =
...
case class ofp_queue_get_config_reply private[sdriver](
  header: ofp_header,
  port: UInt32,
  pad: Pad4,
