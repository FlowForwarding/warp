...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.multipart.{ArrayMultipartRequestBodyInput, MultipartReplyBody}
...
private[fixed] trait Ofp13TableFeaturesDescription extends StructureDescription {
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlersSet[_, _] with TableFeaturesReplyHandler]
  ...
  class TableFeaturesBuilder extends OfpStructureBuilder[TableFeatures] {
    ...
    override private[fixed] def inputFromTextView(implicit input: BITextView): TableFeatures =
      org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.multipart.data.TableFeatures(
          "table_id",
          string("name"),
          "metadata_match",
          "metadata_write",
