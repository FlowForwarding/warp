...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.mod.{MeterModFlags, GroupModType}
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.multipart.{MultipartReplyBody, EmptyMultipartRequestBodyInput}
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.structures.meter_bands.{Ofp13MeterBandsDescription, MeterBand}
...
private[fixed] trait Ofp13MeterConfigDescription extends StructureDescription {
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlersSet[_, _] with MeterConfigReplyHandler] with Ofp13MeterBandsDescription =>
