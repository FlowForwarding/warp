...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.Role.Role
...
private[fixed] trait Ofp13RoleDescription extends Ofp13MessageDescription {
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlersSet[_, _] with RoleReplyHandler] with Ofp13HeaderDescription =>
