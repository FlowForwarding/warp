...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.structures.{GroupId, Ofp13HeaderDescription}
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.structures.{Ofp13BucketDescription, Bucket}
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.mod.GroupModCommand.GroupModCommand
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.controller.mod.GroupModType.GroupModType
...
private[fixed] trait Ofp13GroupModDescription extends Ofp13MessageDescription{
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlersSet[_, _]] with Ofp13HeaderDescription with Ofp13BucketDescription =>
