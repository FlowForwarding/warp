...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.async.PortReason.PortReason
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.structures.{Ofp13HeaderDescription, Ofp13PortDescription, Port}
import org.flowforwarding.warp.driver_api.fixed.openflow.v13._
...
private[fixed] trait Ofp13PortStatusDescription extends Ofp13MessageDescription{
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlersSet[_, _] with PortStatusHandler] with Ofp13HeaderDescription with Ofp13PortDescription =>
