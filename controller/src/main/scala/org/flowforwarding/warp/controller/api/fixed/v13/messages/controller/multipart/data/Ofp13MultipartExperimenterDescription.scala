...
import org.flowforwarding.warp.controller.api.fixed.v13.messages.controller.multipart.{SingletonMultipartRequestBodyInput, MultipartReplyBody}
...
private[fixed] trait Ofp13MultipartExperimenterDescription extends StructureDescription {
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlers[_, _] with MultipartExperimenterReplyHandler]
  ...
  class MultipartExperimenterBuilder extends OfpStructureBuilder[MultipartExperimenter] {
    ...
    override private[fixed] def inputFromTextView(implicit input: BITextView): MultipartExperimenter =
      org.flowforwarding.warp.controller.api.fixed.v13.messages.controller.multipart.data.MultipartExperimenter(
        "experimenter",
        "exp_type",
        "data")
  }
