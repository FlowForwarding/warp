...
import org.flowforwarding.warp.controller.api.fixed.v13.messages.controller.multipart.{SingletonMultipartRequestBodyInput, MultipartRequestBodyInput, MultipartReplyBody}
...
private[fixed] trait Ofp13IndividualFlowStatisticsDescription extends StructureDescription {
  apiProvider: MessagesDescriptionHelper[_ <: SpecificVersionMessageHandlers[_, _] with IndividualFlowStatisticsReplyHandler] with Ofp13MatchDescription =>
