...
import org.flowforwarding.warp.controller.bus.{ControllerBus, ServiceRequest}
...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.messages.async.{PortReason, PortStatus}
...
import org.flowforwarding.warp.driver_api.fixed.openflow.v13.structures.Port
...
class Ofp13InventoryService(controllerBus: ControllerBus) extends Ofp13MessageHandlers(controllerBus)
                                                             with InventoryService[OFNode, OFNodeConnector]
                                                             with Ofp13Tag {
  import org.flowforwarding.warp.controller.modules.opendaylight_rest.impl.openflow.v13.Ofp13InventoryMessages._
  import org.flowforwarding.warp.controller.modules.opendaylight_rest.managers.InventoryMessages._
